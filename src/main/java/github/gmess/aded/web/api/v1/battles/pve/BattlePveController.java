...
public final class BattlePveController implements BattlePveAPI {
    ...
    public ResponseEntity<?> attack(String id) {
        ...
        final Function<AttackPveBattleOutput, ResponseEntity<?>> onSuccess =
                ResponseEntity::ok;
    ...
    public ResponseEntity<?> damage(String id) {
        ...
        final Function<DamagePveBattleOutput, ResponseEntity<?>> onSuccess =
                ResponseEntity::ok;
    ...
    public ResponseEntity<?> defend(String id) {
        ...
        final Function<DefensePveBattleOutPut, ResponseEntity<?>> onSuccess =
                ResponseEntity::ok;
