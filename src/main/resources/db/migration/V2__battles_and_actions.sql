...
CREATE TABLE battles (
    ...
    contender_current_hp smallint NOT NULL CHECK (contender_current_hp > 0 AND contender_current_hp <= 100),
    contested_current_hp smallint NOT NULL CHECK (contested_current_hp > 0 AND contested_current_hp <= 100),
